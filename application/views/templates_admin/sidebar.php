<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('admin/akun_user') ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            placeholder="Search for...w" aria-label="Search"
                        ...
                        <ul class="na navbar-nav navbar-right mt-2">
                           ...
                           <ul class="na navbar-nav navbar-right ml-4">
                            ...
                            <?php } else { ?>
                            <li class="btn-success btn-sm ml-2"><?php echo anchor('auth/login','Login'); ?></li>
